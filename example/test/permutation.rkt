...
(define LEN #:type int #:configs [1 5] #:for-types)

(define-structure permutation #:type (Vector-type LEN int)
...
(define-structure inverse-permutation #:type (Vector-type LEN int)
  #:value
